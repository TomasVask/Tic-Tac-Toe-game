...
function addListenerGrid1() {
    grid1.addEventListener("click", grid1Listener, { once: true });
};
addListenerGrid1();
...
function addListenerGrid2() {
    grid2.addEventListener("click", grid2Listener, { once: true })
};
addListenerGrid2()
...
async function grid3Listener() {
    ...
    tiesRunner();
    cpuRunnerZero();
} function addListenerGrid3() {
    grid3.addEventListener("click", grid3Listener, { once: true })
};
addListenerGrid3()
...
async function grid4Listener() {
    ...
    tiesRunner();
    cpuRunnerZero();
} function addListenerGrid4() {
    grid4.addEventListener("click", grid4Listener, { once: true })
};
addListenerGrid4()
...
async function grid5Listener() {
    ...
    tiesRunner();
    cpuRunnerZero();
} function addListenerGrid5() {
    grid5.addEventListener("click", grid5Listener, { once: true })
};
addListenerGrid5()
...
async function grid6Listener() {
    ...
    tiesRunner();
    cpuRunnerZero();
} function addListenerGrid6() {
    grid6.addEventListener("click", grid6Listener, { once: true })
};
addListenerGrid6()
...
async function grid7Listener() {
    ...
    tiesRunner();
    cpuRunnerZero();
} function addListenerGrid7() {
    grid7.addEventListener("click", grid7Listener, { once: true })
};
addListenerGrid7()
...
async function grid8Listener() {
    ...
    tiesRunner();
    cpuRunnerZero();
} function addListenerGrid8() {
    grid8.addEventListener("click", grid8Listener, { once: true })
};
addListenerGrid8()
...
async function grid9Listener() {
    ...
    tiesRunner();
    cpuRunnerZero();
} function addListenerGrid9() {
    grid9.addEventListener("click", grid9Listener, { once: true })
};
addListenerGrid9()
